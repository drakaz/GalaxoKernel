...
#define SMB380_I2C_IOCTL_MAGIC 'm'
    
#define ACCS_IOCTL_INIT \
	_IO(ACCS_IOCTL_MAGIC, 1) 
#define ACCS_IOCTL_OPEN \
	_IO(ACCS_IOCTL_MAGIC, 2) 
#define ACCS_IOCTL_CLOSE \
	_IO(ACCS_IOCTL_MAGIC, 3) 
